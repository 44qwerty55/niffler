...
public class SpendCondition {
    ...
    public static CollectionCondition spends(SpendDto... expectedSpends) {
        return new CollectionCondition() {
            ...
            public boolean test(List<WebElement> elements) {
                ...
                for (int i = 0; i < expectedSpends.length; i++) {
                    ...
                    SpendDto expectedSpending = expectedSpends[i];
            ...
            private List<SpendDto> bindElementsToSpends(List<WebElement> elements) {
                return elements.stream()
                        .map(e -> {
                            List<WebElement> cells = e.findElements(By.cssSelector("td"));
                            SpendDto actual = new SpendDto();
