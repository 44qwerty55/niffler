...
import niffler.data.dao.PostgresJdbcAuthnDAO;
import niffler.data.dao.PostgresSpringJdbcAuthnDAO;
...
public class DAOResolverAuthn implements TestInstancePostProcessor {
    ...
    public void postProcessTestInstance(Object testInstance, ExtensionContext context) throws Exception {
        ...
        for (Field field : fields) {
            field.set(testInstance, System.getProperty("dao", "jpa").equals("jpa")
                    ? new PostgresJdbcAuthnDAO()
                    : new PostgresSpringJdbcAuthnDAO());
        }
    }
}
